...
describe("AppShell", () => {
  it("renders notification access and settings navigation", async () => {
    ...
    const notifications = await screen.findByRole("button", { name: /Notifications/i });
    const settings = await screen.findAllByTitle(/Paramètres/i);
